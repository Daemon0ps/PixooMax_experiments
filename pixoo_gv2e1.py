...
def imgtxt(txt:str=""):
    ...
    fnt = ImageFont.truetype("/mnt/e/rule34/JetBrainsMono-ExtraBold.ttf",randint(18,24))
...
_fps = 30
_interval = 20
_frames = (_fps * _interval) 
_sb_ = statbar(_frames,"anim_gen")
anim = animation.FuncAnimation(fig, anim, frames = _frames, interval = _interval) 
anim.save(f'/mnt/e/pixoo/oscillatory_mechanics_test12.mp4', writer = 'ffmpeg', fps = _fps)
_sb_.close()
vidframes:list=[]
vidcap = cv2.VideoCapture('/mnt/e/pixoo/oscillatory_mechanics_test12.mp4')
success,image = vidcap.read()
count = 0
_sb_ = statbar(_frames,"anim_gen")
